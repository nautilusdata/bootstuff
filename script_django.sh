...
curl -O https://github.com/nautilusdata/bootstuff/blob/main/bootstrap.min.css
curl -O https://github.com/nautilusdata/bootstuff/blob/main/bootstrap.bundle.min.js
